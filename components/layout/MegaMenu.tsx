    ...
    <div ref={menuRef} className="relative">
      <button
        ...
        className={`flex items-center gap-1 text-sm font-medium transition-colors duration-300 ${
          open || pathname === "/services" || pathname.startsWith("/services/")
            ? "text-primary"
      ...
      {open && (
        <div
          className="fixed left-1/2 top-20 z-50 w-[min(1000px,calc(100vw-2rem))] -translate-x-1/2 overflow-hidden rounded-lg border border-border/60 bg-background shadow-2xl"
        >
